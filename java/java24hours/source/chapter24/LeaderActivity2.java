...
public class LeaderActivity2 extends Activity {
    public static final String TAG = "Leader 2";
        ...
        switch (id) {
            case (R.id.phonebutton):
                ...
                action = new Intent(Intent.ACTION_DIAL,
                    Uri.parse("tel:39-06-69883145"));
                startActivity(action);
                break;
            case (R.id.webbutton):
            	Log.i(TAG, "Loading browser");
                action = new Intent(Intent.ACTION_VIEW,
                    Uri.parse("http://www.vatican.net"));
                startActivity(action);
                break;
            case (R.id.mapbutton):
            	Log.i(TAG, "Loading map");
                action = new Intent(Intent.ACTION_VIEW,
                    Uri.parse("geo:0,0?q=Vatican City"));
                startActivity(action);
                break;
            default:
                break;
