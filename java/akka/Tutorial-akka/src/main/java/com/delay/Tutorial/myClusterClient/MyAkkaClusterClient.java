package com.delay.Tutorial.myClusterClient;
...
import com.delay.Tutorial.myClusterServer.TransformationMessages;
import static com.delay.Tutorial.myClusterServer.TransformationMessages.BACKEND_REGISTRATION;
...
public class MyAkkaClusterClient extends UntypedActor {
    ...
    public void onReceive(Object message) {
        ...
        } else if ((Integer)message == BACKEND_REGISTRATION) {
            /**
             * 注册服务提供者
             */
